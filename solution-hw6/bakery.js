...
// }
// //dynamicially populating the options of my glazingOptions dropdown field via a loop//
// for (const glazingOption in glazing) {
//     if (glazing.hasOwnProperty(glazingOption)) {
//         const option = document.createElement('option');
//         option.value = glazingOption;
//         option.text = glazingOption;
//         glazingOptions.appendChild(option);
//     }
// }
// for (const packOption in packSize) {
//     if (packSize.hasOwnProperty(packOption)) {
//         const option = document.createElement('option');
